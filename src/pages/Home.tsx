          ...
          <div className="container v-align-transform">
            <div className="row">
              <div className="col-sm-12 text-center" data-aos="fade-up">
                ...
                <h5 className="mb32 mb-xs-16" data-aos="fade-up" data-aos-delay="300" style={{ fontFamily: "'Avenir Next', system-ui, -apple-system, sans-serif", fontWeight: 700, fontSize: '36px', letterSpacing: '0.15em', marginTop: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', lineHeight: '1' }}>
                  <span>One Ball</span>
                  <span style={{ color: '#C9D49C', margin: '0 10px', fontSize: '120px', lineHeight: '0', display: 'inline-flex', alignItems: 'center' }}>·</span>
                  <span>One World</span>
                </h5>
