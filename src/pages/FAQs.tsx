          ...
          <div className="container">
            ...
            <div className="row" data-aos="fade-up" data-aos-delay="200">
              <div className="col-sm-10 col-sm-offset-1">
                <Accordion items={faqItems} defaultOpen={false} />
              </div>
            </div>
          </div>
        </section>
